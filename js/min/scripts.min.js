...
jQuery(document).ready(function(t){t(document).on("click",'a[href^="#"]',function(o){o.preventDefault(),t("html, body").animate({scrollTop:t(t.attr(this,"href")).offset().top},500)}),t(".container-card-category .card-category button").click(function(){t(".container-card-category .card-category").removeClass("active"),t(this).parents(".card-category").addClass("active")}),t(".container-option-tema .option-box").click(function(){t(".container-option-tema .option-box").removeClass("active"),t(this).addClass("active")})});